...
/* harmony import */ var _State__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./State */ "./src/javascripts/State.js");
/* harmony import */ var _Vec__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Vec */ "./src/javascripts/Vec.js");
...
var SIZE = new _Vec__WEBPACK_IMPORTED_MODULE_5__["default"](4, 2);
var dir = 0;

var FlyGuardian =
/*#__PURE__*/
function () {
  function FlyGuardian(_pos, _speed, reset, _action) {
    var _this = this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, FlyGuardian);

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(this, "collide", function (state) {
      return new _State__WEBPACK_IMPORTED_MODULE_4__["default"](state.level, state.actors, 'lost');
    });
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(this, "update", function (time, state) {
      ...
      var frame = Math.round(_this.pos.x) % 2 + 1;
      var action = "frame-".concat(frame);

      if (state.level.touches(newPos, _this.size, 'wall')) {
        return new FlyGuardian(_this.pos, _this.speed.times(-1), null, action);
      }

      var anotherGuardian = state.actors.find(_this._isTouchingAnotherFlyGuardian);

      if (anotherGuardian) {
        var speed = _this.speed;
        var pos = _this.pos;

        if (speed.x > 0 && _this.pos.x < anotherGuardian.pos.x) {
          speed = speed.times(-1);
        ...
        return new FlyGuardian(pos, speed, _this.reset, action);
      }

      if (_this.reset) {
        return new FlyGuardian(_this.reset, _this.speed, _this.reset, action);
      }

      return new FlyGuardian(newPos, _this.speed, _this.reset, action);
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(this, "_isTouchingAnotherFlyGuardian", function (actor) {
      if (actor == _this || actor.type !== 'fly-guardian') {
        return false;
      }

      return _this.boundingBox.isOverlapping(actor.boundingBox);
    });
    ...
    this.action = _action || 'frame-1';
    this.boundingBox = new _BoundingBox__WEBPACK_IMPORTED_MODULE_3__["default"](_pos, SIZE);
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(FlyGuardian, null, [{
    key: "create",
    value: function create(pos, ch) {
      dir++;
      var speed = dir % 2 ? new _Vec__WEBPACK_IMPORTED_MODULE_5__["default"](2, 0) : new _Vec__WEBPACK_IMPORTED_MODULE_5__["default"](-2, 0);
...
var initialInteractionEvents = ['touchend', 'mouseup', 'keyup']; // Long sound must be trigged by user's interaction.
...
function playGameSound(event) {
  ...
  if (_Sound__WEBPACK_IMPORTED_MODULE_6__["default"].get('playing_1.mp3').play(true)) {
    initialInteractionEvents.forEach(function (type) {
...
var Game = function Game() {
  ...
  document.body.appendChild(viewport); // Long sound must be trigged by user's interaction first.
...
/*#__PURE__*/
function () {
  function Lava(pos, speed, reset, action) {
    var _this = this;
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(this, "update", function (time, state) {
      ...
      if (!state.level.touches(newPos, _this.size, 'wall')) {
        return new Lava(newPos, _this.speed, _this.reset, _this.action);
      } else if (_this.reset) {
        return new Lava(_this.reset, _this.speed, _this.reset, _this.action);
      } else {
        return new Lava(_this.pos, _this.speed.times(-1), null, _this.action);
      }
    });
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Lava, null, [{
    ...
    value: function create(pos, ch) {
      if (ch == '=') {
        return new Lava(pos, new _Vec__WEBPACK_IMPORTED_MODULE_4__["default"](2, 0), null, 'movex');
      } else if (ch == '|') {
        return new Lava(pos, new _Vec__WEBPACK_IMPORTED_MODULE_4__["default"](0, 2), null, 'movey');
      } else if (ch == 'v') {
        return new Lava(pos, new _Vec__WEBPACK_IMPORTED_MODULE_4__["default"](0, 3), pos, 'drop');
      }
    }
  }]);
...
/*#__PURE__*/
function () {
  function Monster(pos, speed, reset, attrs) {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(this, "action", null);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Monster, [{
    ...
    value: function update(time, state) {
      ...
      if (!state.level.touches(newPos, this.size, 'wall')) {
        ...
        return new Monster(this.pos, this.speed.times(-1), null, {
          action: action
        });
      }
    }
...
/*#__PURE__*/
function () {
  function Player(_pos, _speed, _direction, _action) {
    var _this = this;
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(this, "update", function (time, state, keys) {
      ...
      var sound;
      var player = new Player(pos, speed, direction, action);
