...
function _isOverlapping(boxA, boxB) {
  return isPointAtBox(boxA.pos, boxB) || isPointAtBox(new _Vec__WEBPACK_IMPORTED_MODULE_2__["default"](boxA.pos.x + boxA.size.x, boxA.pos.y), boxB) || isPointAtBox(new _Vec__WEBPACK_IMPORTED_MODULE_2__["default"](boxA.pos.x, boxA.size.y + boxA.pos.y), boxB) || isPointAtBox(new _Vec__WEBPACK_IMPORTED_MODULE_2__["default"](boxA.pos.x + boxA.size.x, boxA.size.y + boxA.pos.y), boxB);
}
...
function () {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(BoundingBox, [{
    ...
    value: function isOverlapping(box) {
      return _isOverlapping(box, this) || _isOverlapping(this, box);
    }
  }, {
    key: "toString",
    value: function toString() {
      return "(".concat(this.pos, " - ").concat(this.size, ")");
    }
  }]);
...
/* harmony import */ var _getViewportSize__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./getViewportSize */ "./src/javascripts/getViewportSize.js");
/* harmony import */ var _log__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./log */ "./src/javascripts/log.js");
...
function drawGrid(level) {
  ...
  }].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_4___default()(level.rows.map(function (row) {
    return elt.apply(void 0, ['tr', {
      style: "height: ".concat(scale, "px")
    }].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_4___default()(row.map(function (type) {
      return elt('td', {
        "class": type
      });
    }))));
...
function drawActors(actors) {
  return elt.apply(void 0, ['div', {
    "class": 'actors'
  }].concat(_babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_4___default()(actors.map(function (actor) {
    var rect = elt('div', {
    ...
    rect.style.left = px;
    rect.style.top = py;
    var attrs = actor.attrs;

    if (attrs) {
      Object.keys(attrs).forEach(function (key) {
        var val = attrs[key];

        var vt = _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_3___default()(val);

        if (vt === 'string' || vt === 'number' || vt === 'boolean') {
          if (key === 'rotate' || key === 'opacity' || key === 'perspective' || key === 'skew') {
            rect.style.setProperty("--".concat(key), val);
          } else {
            rect.setAttribute("data-".concat(key), val);
          }
        }
      });
    }
...
function () {
  function DOMDisplay(parent, level) {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(this, "_autoScale", function (event) {
      ...
      var _getViewportSize = Object(_getViewportSize__WEBPACK_IMPORTED_MODULE_5__["default"])(),
...
/* harmony import */ var _clamp__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./clamp */ "./src/javascripts/clamp.js");
...
var SIZE = new _Vec__WEBPACK_IMPORTED_MODULE_6__["default"](4, 4);
var ATTACK_POS_OFFSET = new _Vec__WEBPACK_IMPORTED_MODULE_6__["default"](1.5, 1.5);
var ATTACK_SIZE_OFFSET = new _Vec__WEBPACK_IMPORTED_MODULE_6__["default"](-1, -1);

function isAttacking(player, guardian) {
  var playerBox = new _BoundingBox__WEBPACK_IMPORTED_MODULE_4__["default"](player.pos, player.size);
  var attachBox = new _BoundingBox__WEBPACK_IMPORTED_MODULE_4__["default"](guardian.pos.plus(ATTACK_POS_OFFSET), guardian.size.plus(ATTACK_SIZE_OFFSET));
...
function () {
  function FlyGuardian(_pos, _speed, _costume, _attrs) {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "collide", function (state) {
      ...
      if (isAttacking(player, _this)) {
        status = 'lost';
      }

      return new _State__WEBPACK_IMPORTED_MODULE_5__["default"](level, actors, status);
    });

    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_3___default()(this, "update", function (time, state) {
      var now = Date.now();
      var frame = now % 8 <= 4 ? 1 : 2; // deg => 1 ~ -1.

      var deg = Math.cos(now % 3600 / 3600 * Math.PI * 2);
      var rotate = "".concat(deg * 45, "deg");
      var opacity = Object(_clamp__WEBPACK_IMPORTED_MODULE_7__["default"])(Math.abs(deg), 0.2, 0.8);
      var costume = "frame-".concat(frame);
      var skew = "".concat(deg / 20, "turn");
      ...
      var attacking = isAttacking(state.player, _this);
...
var Game = function Game() {
  ...
  var levels = _Configs__WEBPACK_IMPORTED_MODULE_8__["GAME_LEVELS"][levelNumber - 1] ? _Configs__WEBPACK_IMPORTED_MODULE_8__["GAME_LEVELS"].slice(levelNumber - 1) : _Configs__WEBPACK_IMPORTED_MODULE_8__["GAME_LEVELS"];
  runGame(viewport, levels, _DOMDisplay__WEBPACK_IMPORTED_MODULE_3__["default"], inputManager);
...
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @babel/runtime/helpers/defineProperty */ "./node_modules/@babel/runtime/helpers/defineProperty.js");
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _BoundingBox__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./BoundingBox */ "./src/javascripts/BoundingBox.js");
/* harmony import */ var _Vec__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Vec */ "./src/javascripts/Vec.js");
/* harmony import */ var _Sound__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Sound */ "./src/javascripts/Sound.js");
...
var SIZE = new _Vec__WEBPACK_IMPORTED_MODULE_4__["default"](0.8, 1.5);
var playerXSpeed = 7;
var gravity = 30;
var jumpSpeed = 17;
...
function findFloorActor(player, actor) {
  ...
  var feetBox = new _BoundingBox__WEBPACK_IMPORTED_MODULE_3__["default"](new _Vec__WEBPACK_IMPORTED_MODULE_4__["default"](player.pos.x, player.pos.y + player.size.y - 0.5), new _Vec__WEBPACK_IMPORTED_MODULE_4__["default"](player.size.x, 0.5));
  var floorBox = new _BoundingBox__WEBPACK_IMPORTED_MODULE_3__["default"](actor.pos, new _Vec__WEBPACK_IMPORTED_MODULE_4__["default"](actor.size.x, 0.5));
  var rr = feetBox.isOverlapping(floorBox);
...
function () {
  function Player(_pos, _speed, _costume, attrs) {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(this, "update", function (time, state, keys) {
      ...
      var pos = _this.pos;
      var movedX = pos.plus(new _Vec__WEBPACK_IMPORTED_MODULE_4__["default"](xSpeed * time, 0));
      ...
      var movedY = pos.plus(new _Vec__WEBPACK_IMPORTED_MODULE_4__["default"](0, ySpeed * time));
      var floorActor;
      ...
      if (ySpeed > 0) {
        ...
        floorActor = state.actors.find(function (aa) {
          return findFloorActor(player, aa);
        });

        if (floorActor) {
          // Player is standing on the floor actor.
          pos = pos.plus(new _Vec__WEBPACK_IMPORTED_MODULE_4__["default"](floorActor.speed.x * time, 0));
          pos.y = floorActor.pos.y - _this.size.y;
        }
      }

      if (!floorActor && !state.level.touches(movedY, _this.size, 'wall')) {
        pos = movedY;
      ...
      var speed = new _Vec__WEBPACK_IMPORTED_MODULE_4__["default"](xSpeed, ySpeed);
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Player, null, [{
    ...
    value: function create(initialPos) {
      var speed = new _Vec__WEBPACK_IMPORTED_MODULE_4__["default"](0, 0);
      var direction = 'right';
      var costume = 'stand';
      var pos = initialPos.plus(new _Vec__WEBPACK_IMPORTED_MODULE_4__["default"](0, -0.5));
      return new Player(pos, speed, costume, {
        direction: direction
      });
    }
...
function () {
  function Vec(x, y) {
    ...
    if (isNaN(x) || isNaN(y)) {
      throw new Error("Invalid value ".concat(this.toString()));
    }
  }
...
window.onload = function () {
  var matches = window.location.search.match(/level=(\d+)/);
  var level = matches && +matches[1];
  new _Game__WEBPACK_IMPORTED_MODULE_0__["default"](level || 1);
};
