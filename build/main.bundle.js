...
function () {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(BoundingBox, [{
    ...
    value: function isOverlapping(box) {
      return _isOverlapping(box, this); // || isOverlapping(this, box);
    }
  }]);
...
var ATTACK_POS_OFFSET = new _Vec__WEBPACK_IMPORTED_MODULE_6__["default"](1, 1);
...
function isAttacking(player, guardian) {
  ...
  var guardianBox = new _BoundingBox__WEBPACK_IMPORTED_MODULE_4__["default"](guardian.pos.plus(ATTACK_POS_OFFSET), guardian.size.plus(ATTACK_SIZE_OFFSET));
