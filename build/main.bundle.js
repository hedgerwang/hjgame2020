...
/*#__PURE__*/
function () {
  function FlyGuardian(_pos, _speed, reset, _costume) {
    var _this = this;
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(this, "update", function (time, state) {
      ...
      if (state.level.touches(newPos, _this.size, 'wall')) {
        return new FlyGuardian(_this.pos, _this.speed.times(-1), null, costume);
      }
      ...
      if (anotherGuardian) {
        ...
        return new FlyGuardian(pos, speed, _this.reset, costume);
      }

      if (_this.reset) {
        return new FlyGuardian(_this.reset, _this.speed, _this.reset, costume);
      }

      return new FlyGuardian(newPos, _this.speed, _this.reset, costume);
    });
...
/*#__PURE__*/
function () {
  function Lava(pos, speed, reset, costume) {
    var _this = this;
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(this, "update", function (time, state) {
      ...
      if (!state.level.touches(newPos, _this.size, 'wall')) {
        return new Lava(newPos, _this.speed, _this.reset, _this.costume);
      } else if (_this.reset) {
        return new Lava(_this.reset, _this.speed, _this.reset, _this.costume);
      } else {
        return new Lava(_this.pos, _this.speed.times(-1), null, _this.costume);
      }
    });
...
/*#__PURE__*/
function () {
  function Player(_pos, _speed, _costume, _direction) {
    var _this = this;
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default()(this, "update", function (time, state, keys) {
      ...
      var sound;
      var player = new Player(pos, speed, costume, direction);
